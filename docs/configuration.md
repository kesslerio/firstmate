...
Codex `max` is valid only when the profile selects `gpt-6-luna`.
The [Codex harness reference](../.agents/skills/harness-adapters/references/harness/codex.md) owns catalog evidence and launch mapping.
