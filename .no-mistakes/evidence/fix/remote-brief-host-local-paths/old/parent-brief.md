...
Nobody reads this chat: the captain and the main firstmate see only what is appended to '/private/var/folders/lw/83_wpdv92g5ff57h6hflw6wr0000gp/T/fm-remote-secondmate-e2e.fmU9Kz/parent/state/ios.status', and a captain-facing sentence that is not appended there has not been sent.
...
Report only true captain-relevant outcomes or a declared external wait by appending one line:
   `echo "{state} [at=<epoch>]: {one short line}" >> '/private/var/folders/lw/83_wpdv92g5ff57h6hflw6wr0000gp/T/fm-remote-secondmate-e2e.fmU9Kz/parent/state/ios.status'`
